...
// NIXCAPRA: Here KEY_CIRCLE is swapped with KEY_DELETE
...
// Fourth row
// NIXCAPRA: Here HID_KEYBOARD_SC_APPLICATION is swapped with KEY_CIRCLE, this eliminates the APPLICATION key completely from the matrix
